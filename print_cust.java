...
public class print_cust extends JInternalFrame implements Printable

 {
	...
	//constructor of JLibrary
	    public print_cust(String query) {
		super("Printing Customer", false, true, false, true);
		...
		try {
			...
			textArea.append(" ---------------------------------------------------------------------------------------\n");
			textArea.append("cust no      Name      Address      Age    Tel no    Email "  );
			textArea.append(" ---------------------------------------------------------------------------------------\n");
