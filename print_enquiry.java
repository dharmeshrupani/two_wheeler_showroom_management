...
public class print_enquiry extends JInternalFrame implements Printable 
 {
	...
	public print_enquiry(String query) {
		super("Printing Enquiry", false, true, false, true);
		...
		try {
			...
			textArea.append("\t*************** Enquiry Information ***************\n");
			textArea.append(" ---------------------------------------------------------------------------------------\n");
			textArea.append("Enq no      Cust no      Date      Enq veh    "  );
			textArea.append(" ---------------------------------------------------------------------------------------\n");
